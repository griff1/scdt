  ...
  if (m_socket == 0)
    {
      ...
      if (Ipv4Address::IsMatchingType(m_rootIp) == true)
        ...
        {
          if (Ipv6Address::IsMatchingType (m_rootIp) == true) 
            {
              NS_LOG_FUNCTION (this << "It's an Ipv6 addr!");
            }
